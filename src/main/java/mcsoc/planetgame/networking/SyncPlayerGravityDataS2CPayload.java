...
public record SyncPlayerGravityDataS2CPayload(
    Direction gravity_direction, GravityStrength gravity_strength_modifier
    ) implements CustomPayload {

    public static final CustomPayload.Id<SyncPlayerGravityDataS2CPayload> ID = new CustomPayload.Id<>(NetworkingIdentifiers.PLAYER_SYNC_GRAVITY_PACKET_ID);
