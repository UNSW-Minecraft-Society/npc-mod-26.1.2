...
public record SyncPlayerGravityDataS2CPayload(Direction gravity_direction, Double gravity_strength_modifier) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, SyncPlayerGravityDataS2CPayload> CODEC = PacketCodec.tuple(
        ...
        PacketCodecs.DOUBLE, SyncPlayerGravityDataS2CPayload::gravity_strength_modifier,
