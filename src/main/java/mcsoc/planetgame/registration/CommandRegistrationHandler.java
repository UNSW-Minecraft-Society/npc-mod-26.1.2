        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> {
            ...
            dispatcher.register(CommandManager.literal("set_ability")
                ...
                .then(CommandManager.literal("second")
                    .then(CommandManager.literal("none")
                    .executes(GameEffects.CommandActions::setCallingPlayerSecondAbilityNone)
                        .then(CommandManager.argument(PLAYER_NAME_ARGUMENT, StringArgumentType.string())
                        .suggests(new OnlinePlayerSuggestionProvider())
                        .executes(GameEffects.CommandActions::setTargetPlayerSecondAbilityNone)
                        )
                    )
                    .then(CommandManager.literal("xray")
                    .executes(GameEffects.CommandActions::setCallingPlayerSecondAbilityXray)
                        .then(CommandManager.argument(PLAYER_NAME_ARGUMENT, StringArgumentType.string())
                        .suggests(new OnlinePlayerSuggestionProvider())
                        .executes(GameEffects.CommandActions::setTargetPlayerSecondAbilityXray)
                        )
                    )
                    .then(CommandManager.literal("drill")
                    .executes(GameEffects.CommandActions::setCallingPlayerSecondAbilityDrill)
                        .then(CommandManager.argument(PLAYER_NAME_ARGUMENT, StringArgumentType.string())
                        .suggests(new OnlinePlayerSuggestionProvider())
                        .executes(GameEffects.CommandActions::setTargetPlayerSecondAbilityDrill)
                        )
                    )
                )
                .then(CommandManager.literal("third")
                    .then(CommandManager.literal("none")
                    .executes(GameEffects.CommandActions::setCallingPlayerThirdAbilityNone)
                        .then(CommandManager.argument(PLAYER_NAME_ARGUMENT, StringArgumentType.string())
                        .suggests(new OnlinePlayerSuggestionProvider())
                        .executes(GameEffects.CommandActions::setTargetPlayerThirdAbilityNone)
                        )
                    )
                    .then(CommandManager.literal("dash_add")
                    .executes(GameEffects.CommandActions::setCallingPlayerThirdAbilityDash)
                        .then(CommandManager.argument(PLAYER_NAME_ARGUMENT, StringArgumentType.string())
                        .suggests(new OnlinePlayerSuggestionProvider())
                        .executes(GameEffects.CommandActions::setTargetPlayerThirdAbilityDash)
                        )
                    )
                    .then(CommandManager.literal("dash_abs")
                    .executes(GameEffects.CommandActions::setCallingPlayerThirdAbilityDashAbsolute)
                        .then(CommandManager.argument(PLAYER_NAME_ARGUMENT, StringArgumentType.string())
                        .suggests(new OnlinePlayerSuggestionProvider())
                        .executes(GameEffects.CommandActions::setTargetPlayerThirdAbilityDashAbsolute)
                        )
                    )
                    .then(CommandManager.literal("throw")
                    .executes(GameEffects.CommandActions::setCallingPlayerThirdAbilityThrow)
                        .then(CommandManager.argument(PLAYER_NAME_ARGUMENT, StringArgumentType.string())
                        .suggests(new OnlinePlayerSuggestionProvider())
                        .executes(GameEffects.CommandActions::setTargetPlayerThirdAbilityThrow)
                        )
                    )
                )
            );
